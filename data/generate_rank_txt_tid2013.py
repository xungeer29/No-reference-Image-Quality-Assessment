...
"""
使用Waterloo数据集生成5个质量等级的图片，用于训练tid2013数据集
 程序最终生成 tid2013_train.txt 和 tid2013_test.txt
 txt中：图像绝对路径   浮点型的0.00-5.00的等级标签
改为只有4种 distortion 
"""
import numpy as np
...
dir_rank = '/data2/gaofuxun/data/RankIQA/rank_live/'   # Change to your data folder 
...
for t in folder:
    ...
    # DisType = os.listdir(t) # old
    DisType = os.listdir(dir_rank + t) # new
    DisType.sort()
