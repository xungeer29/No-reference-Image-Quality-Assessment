...
MODEL_FILE = './_src/FT/tid2013/deploy_vgg.prototxt'
PRETRAINED_FILE = './models/ft_rank_tid2013/' +'FT_tid2013.caffemodel'
tp = 'FT_all' 
...
srocc_file = open(  res_dir+ tp + '_srocc_224' + '.txt', "w")
lcc_file = open( res_dir + tp + '_lcc_224' + '.txt', "w")
