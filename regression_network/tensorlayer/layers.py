...
class Conv2dLayer(Layer):
    ...
    def __init__(
        ...
        with tf.variable_scope(name) as vs:
            if np_weights:
                W = tf.get_variable(name='W_conv2d', initializer=W_init, **W_init_args )
            else:
...
def Conv2d(net, n_filter=32, filter_size=(3, 3), strides=(1, 1), act = None,
        ...
        W_init_args = {}, b_init_args = {}, use_cudnn_on_gpu = None, data_format = None,name ='conv2d',np_weights = False):
